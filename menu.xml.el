...
<xfdesktop-menu>
	...
	<title name="Μενού Επιφάνειας Εργασίας" icon="xfce4-backdrop"/>

	<separator/>

	<app name="Εκτέλεση..." cmd="xfrun4" icon="gnome-fs-executable"/>

	<separator/>

	<app name="Τερματικό" cmd="xfterm4" icon="gnome-terminal"/>
	<app name="Διαχειριστής Αρχείων (xffm)" cmd="xffm" icon="file-manager"/>
	<app name="Περιηγητής Ιστού" cmd="mozilla" icon="gnome-globe"/>
    ...
    <app name="Βοήθεια" cmd="xfhelp4" icon="gnome-help"/>
    <app name="Περί του Xfce" cmd="xfce4-about" icon="gnome-info"/>
    <!--
    ...
    -->
    <builtin name="Έξοδος" cmd="quit" icon="gnome-logout"/>
