/* $Id: frap-menu-or-rules.h 24502 2007-01-16 10:08:36Z jannis $ */
...
#define FRAP_MENU_OR_RULES(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), FRAP_TYPE_MENU_OR_RULES, FrapMenuOrRules))
#define FRAP_MENU_OR_RULES_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), FRAP_TYPE_MENU_OR_RULES, FrapMenuOrRulesClass))
#define FRAP_IS_MENU_OR_RULES(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), FRAP_TYPE_MENU_OR_RULES))
#define FRAP_IS_MENU_OR_RULES_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE ((obj), FRAP_TYPE_MENU_OR_RULES))
#define FRAP_MENU_OR_RULES_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS ((obj), FRAP_TYPE_MENU_OR_RULES, FrapMenuOrRulesClass))
