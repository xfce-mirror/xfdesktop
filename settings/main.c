                                     ...
                                     AppearancePanel *panel)
{
    ...
    xfconf_g_property_bind(channel, DESKTOP_MENU_SHOW, G_TYPE_BOOLEAN,
                           G_OBJECT(w), "active");
    ...
    xfconf_g_property_bind(channel, DESKTOP_MENU_SHOW_ICONS,
                           G_TYPE_BOOLEAN,
    ...
    xfconf_g_property_bind(channel, WINLIST_SHOW_APP_ICONS, G_TYPE_BOOLEAN,
                           gtk_builder_get_object(main_gxml, "chk_winlist_show_app_icons"),
                           "active");

    xfconf_g_property_bind(channel, WINLIST_SHOW_STICKY_WIN_ONCE,
                           G_TYPE_BOOLEAN,
                           gtk_builder_get_object(main_gxml, "chk_show_winlist_sticky_once"),
                           "active");

    xfconf_g_property_bind(channel, WINLIST_SHOW_ADD_REMOVE_WORKSPACES,
                           G_TYPE_BOOLEAN,
    ...
    xfconf_g_property_bind(channel, WINLIST_SHOW_WS_NAMES, G_TYPE_BOOLEAN,
                           G_OBJECT(w), "active");
    ...
    xfconf_g_property_bind(channel, WINLIST_SHOW_WS_SUBMENUS,
                           G_TYPE_BOOLEAN,
...
#endif
    xfconf_g_property_bind(channel, DESKTOP_ICONS_STYLE, G_TYPE_INT,
                           G_OBJECT(w), "active");

    /* Orientation combo */
    w = GTK_WIDGET(gtk_builder_get_object(main_gxml, "combo_orientation"));
    gtk_combo_box_set_active(GTK_COMBO_BOX(w), 0);
    xfconf_g_property_bind(channel, DESKTOP_ICONS_GRAVITY, G_TYPE_INT,
                           G_OBJECT(w), "active");
    g_signal_connect(G_OBJECT(w), "changed",
                     G_CALLBACK(cb_xfdesktop_icon_orientation_changed), NULL);

    /* bindings */
    xfconf_g_property_bind(channel, DESKTOP_ICONS_FONT_SIZE, G_TYPE_DOUBLE,
    ...
    xfconf_g_property_bind(channel, DESKTOP_ICONS_CUSTOM_FONT_SIZE,
                           ...
                           "active");
    xfconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_TOOLTIP,
                           G_TYPE_BOOLEAN, G_OBJECT(chk_show_tooltips),
                           "active");
    xfconf_g_property_bind(channel, DESKTOP_ICONS_TOOLTIP_SIZE, G_TYPE_DOUBLE,
    ...
    xfconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_THUMBNAILS,
                           ...
                           "active");
    xfconf_g_property_bind(channel, DESKTOP_ICONS_SINGLE_CLICK,
