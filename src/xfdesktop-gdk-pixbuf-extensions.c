 ...
 **/
GdkPixbuf*
xfdesktop_gdk_pixbuf_colorize (const GdkPixbuf *src,
 ...
 **/
GdkPixbuf*
xfdesktop_gdk_pixbuf_lucent (const GdkPixbuf *src,
                             guint            percent)
{
  GdkPixbuf *dst;
  guchar    *dst_pixels;
...
/**
 * xfdesktop_gdk_pixbuf_spotlight:
 * @src : the source #GdkPixbuf.
 *
 ...
 **/
GdkPixbuf*
xfdesktop_gdk_pixbuf_spotlight (const GdkPixbuf *src)
{
  GdkPixbuf *dst;
  gboolean   has_alpha;
  gint       dst_row_stride;
