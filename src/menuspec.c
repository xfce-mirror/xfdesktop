		...
		gpointer user_data, GError **error)
{
	...
	if(!strcmp(element_name, "category")) {
		gchar *cur_displayname = NULL, *cat_dupe = NULL;
...
gboolean
menuspec_parse_categories(const gchar *filename)
{
 ...
 */
GPtrArray *
menuspec_get_path_simple(const gchar *categories)
{
	GPtrArray *paths;
...
GPtrArray *
menuspec_get_path_multilevel(const gchar *categories)
{
	GPtrArray *paths;
	gchar **cats = NULL;
	struct MenuTreeFindPathInfo mtfpi;
