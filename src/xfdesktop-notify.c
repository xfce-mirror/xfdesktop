...
show_notification(const gchar *summary, const gchar *message, GIcon *icon, gint timeout) {
...
xfdesktop_notify_unmount (GMount *mount)
{
  ...
  notification = show_notification(summary, message, icon, NOTIFY_EXPIRES_NEVER);
  ...
  if (unmount_successful)
    {
      ...
      notification = show_notification(summary, message, icon, NOTIFY_EXPIRES_DEFAULT);
...
do_notify_eject(GObject *volume_or_mount, const gchar *name, GIcon *icon, gboolean read_only) {
    ...
    NotifyNotification *notification = show_notification(summary, message, icon, NOTIFY_EXPIRES_NEVER);
    if (notification != NULL) {
...
eject_finish_handle_notification(GObject *volume_or_mount, const gchar *name, GIcon *icon, gboolean eject_successful) {
    ...
    if (eject_successful) {
        ...
        show_notification(summary, message, icon, NOTIFY_EXPIRES_DEFAULT);
