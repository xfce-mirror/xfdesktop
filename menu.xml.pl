...
<xfdesktop-menu>
	...
	<app name="Menadżer Plików (xffm)" cmd="xffm" icon="file-manager"/>
	<app name="Przeglądarka internetowa" cmd="mozilla" icon="gnome-globe"/>

	<separator/>

	<menu name="Ustawienia" icon="gnome-settings">
		<app name="Ustawienia" cmd="xfce-setting-show" icon="gnome-settings"/>
	</menu>
