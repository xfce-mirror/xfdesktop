...
<xfdesktop-menu>
	...
	<app name="Spustit aplikaci..." cmd="xfrun4" icon="gnome-fs-executable"/>

	<separator/>

	<app name="Terminál" cmd="xfterm4" icon="gnome-terminal"/>
	<app name="Správce souborů" cmd="thunar" icon="file-manager"/>
	<app name="Webový prohlížeč" cmd="xfbrowser4" icon="gnome-globe"/>

	<separator/>

	<menu name="Nastavení" icon="gnome-settings">
		<app name="Správce nastavení" cmd="xfce-setting-show" snotify="true" icon="gnome-settings"/>
	</menu>
    ...
    -->
    <builtin name="Ukončit" cmd="quit" icon="gnome-logout"/>
