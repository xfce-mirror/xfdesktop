  ...
  while ((response = gtk_dialog_run (GTK_DIALOG (dialog)))) {
    if (response == GTK_RESPONSE_OK) {
      ...
      case LAUNCHER:
        ...
        name = menueditor_markup_printf_escaped (NAME_FORMAT, gtk_entry_get_text (GTK_ENTRY (entry_name)));
      ...
      case SUBMENU:
        ...
        name = menueditor_markup_printf_escaped (MENU_FORMAT, gtk_entry_get_text (GTK_ENTRY (entry_name)));
        command = g_strdup ("");
        break;
      case SEPARATOR:
        /* Set node name */
      ...
      case TITLE:
        ...
        name = menueditor_markup_printf_escaped (TITLE_FORMAT, gtk_entry_get_text (GTK_ENTRY (entry_name)));
        command = g_strdup ("");
        break;
      case INCLUDE:
        break;
      case QUIT:
        ...
        name = menueditor_markup_printf_escaped (BUILTIN_FORMAT, gtk_entry_get_text (GTK_ENTRY (entry_name)));
