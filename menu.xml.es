...
<xfdesktop-menu>
    ...
    <separator/>
    <app name="Ejecutar programa..." cmd="xfrun4"/>
    <separator/>
    <app name="Terminal" cmd="xfterm4" />
    <app name="Manejador de archivos" cmd="xffm"/>
    <app name="Navegador de internet" cmd="mozilla"/>
    <separator/>
    <menu name="Configuracion" visible="yes">
        <app name="Administrador..." cmd="xfce-setting-show"/>
        <app name="Fondo de pantalla..." cmd="xfce-setting-show backdrop"/>
<!-- 
...
-->
    ...
    -->
    <builtin name="Salir" cmd="quit" visible="no"/>
