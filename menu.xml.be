...
<xfdesktop-menu>
	...
	<title name="Мэню Xfce" icon="xfce4-backdrop"/>

	<separator/>

	<app name="Выканаць загад..." cmd="xfrun4" icon="gnome-fs-executable"/>

	<separator/>

	<app name="Тэрмінал" cmd="xfterm4" icon="gnome-terminal"/>
	<app name="Кіраўнік файлаў" cmd="thunar" icon="file-manager"/>
	<app name="Гартач сеціва" cmd="xfbrowser4" icon="gnome-globe"/>

	<separator/>

	<menu name="Наладкі" icon="gnome-settings">
		<app name="Кіраўнік наладак" cmd="xfce-setting-show" snotify="true" icon="gnome-settings"/>
	</menu>
    ...
    <app name="Даведка" cmd="xfhelp4" icon="gnome-help"/>
    <app name="Пра Xfce" cmd="xfce4-about" icon="gnome-info"/>
    <!--
    ...
    -->
    <builtin name="Выхад" cmd="quit" icon="gnome-logout"/>
